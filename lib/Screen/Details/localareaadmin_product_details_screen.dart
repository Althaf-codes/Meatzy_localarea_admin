...
class LocalAreaAdminProductDetailsScreen extends StatefulWidget {
  LocalAreaAdminModel localAreaAdminDetails;
  LocalAreaAdminProductDetailsScreen(
      {Key? key, required this.localAreaAdminDetails})
      : super(key: key);

  @override
  State<LocalAreaAdminProductDetailsScreen> createState() =>
      _SignUpScreenState();
}

class _SignUpScreenState extends State<LocalAreaAdminProductDetailsScreen> {
...
////////////////////////////////////////////////////////////////////
  ...
  void dispose() {
    ...
    // liveStockTypeController.dispose();
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: GlobalVariables.secondaryColor),
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        isExpanded: true,
                        underline:
                            Divider(color: GlobalVariables.selectedNavBarColor),
                        elevation: 0,
                        value: dropdownval,
                        iconSize: 20,
                        icon: Icon(
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (formGlobalKey.currentState!.validate()) {
                          ...
                          //       shopimage: widget
                          //           .localAreaAdminDetails["shopImages"]
                          //           .toString(),
                          //       sellerName:
                          //           widget.localAreaAdminDetails['sellerName'],
                          //       contactNumber:
                          //           widget.localAreaAdminDetails['phoneNumber'],
                          //       meatShopName:
                          //           widget.localAreaAdminDetails['shopName'],
                          //       location: SellerLocation(
                          //           coordinates: [
                          //             widget.localAreaAdminDetails['location'][0]
                          //                 .toString(),
                          //             widget.localAreaAdminDetails['location'][1]
                          //                 .toString(),
                          //           ],
                          //           address:
                          //               widget.localAreaAdminDetails['Address'],
                          //           pincode:
                          //               widget.localAreaAdminDetails['pincode']),
                          //       isNewMeatSeller: true,
                          //       isActive: true,
                          //       timings: Timings(
                          //           closingTime:
                          //               widget.localAreaAdminDetails['timings']
                          //                   ['closingTime'],
                          //           noOfOpenDays:
                          //               widget.localAreaAdminDetails['timings']
                          //                   ['noOfOpenDays'],
                          ...
                          //       .addMeatlocalAreaAdminDetails(context,
                          ...
                          //     prefs.setBool("islocalAreaAdminRegistered", true);
                          ...
                          uploadFile(productId: productUid).then((value) {
                            LiveStockDetails liveStockDetails =
                              ...
                              boughtOwnerPhone: boughtOwnerPhoneController.text,
                              boughtOwnerName: boughtOwnerNameController.text,
                              boughtOwnerAddress:
                              ...
                              deadlinePayTime: deadlinePayTimeController.text,
                              buyerId: "",
                              orderId: "",
                              deliveryDateAndTime: "",
                              deliveryLocation: DeliveryLocation(
                                  address: "", coordinates: [], pincode: ""),
                              ...
                              isOnSpotDelivery: false,
                              isbutcherNeeded: false,
                              cattleIdNo: int.parse(cattleIdNoController.text),
                            ...
                            localAreaAdminService
                                .addLocalAreaAdminDetails(context,
                                    localAreaAdminModeldata:
                                        widget.localAreaAdminDetails,
                                    productId: productUid,
                                    liveStockdetails: liveStockDetails)
                                .then((value) async {
                              final prefs =
